...
def make_get_request(url, auth=None, headers=None, data=None):
    ...
    try:
        ...
        frappe.flags.integration_request = s.get(
...
def make_post_request(url, auth=None, headers=None, data=None):
    ...
    try:
        s = get_request_session()
        frappe.flags.integration_request = s.post(
...
def get_checkout_url(**kwargs):
    try:
        ...
        frappe.respond_as_web_page(
            ...
            _(
                "Looks like something is wrong with this site's payment gateway"
                " configuration. No payment has been made."
            ),
            indicator_color="red",
