...
class TestDashboardChart(unittest.TestCase):
    def test_period_ending(self):
        self.assertEqual(
            get_period_ending("2019-04-10", "Daily"), getdate("2019-04-10")
        )

        # week starts on monday
        self.assertEqual(
            get_period_ending("2019-04-10", "Weekly"), getdate("2019-04-14")
        )

        self.assertEqual(
            get_period_ending("2019-04-10", "Monthly"), getdate("2019-04-30")
        )
        self.assertEqual(
            get_period_ending("2019-04-30", "Monthly"), getdate("2019-04-30")
        )
        self.assertEqual(
            get_period_ending("2019-03-31", "Monthly"), getdate("2019-03-31")
        )

        self.assertEqual(
            get_period_ending("2019-04-10", "Quarterly"), getdate("2019-06-30")
        )
        self.assertEqual(
            get_period_ending("2019-06-30", "Quarterly"), getdate("2019-06-30")
        )
        self.assertEqual(
    ...
    def test_chart_wih_one_value(self):
        ...
        frappe.get_doc(
            dict(doctype="Error Log", creation="2018-06-01 00:00:00")
        ).insert()
    ...
    def test_daily_dashboard_chart(self):
        ...
        self.assertEqual(
            ...
            [200.0, 400.0, 300.0, 0.0, 100.0, 0.0],
        )
        self.assertEqual(
            result.get("labels"),
