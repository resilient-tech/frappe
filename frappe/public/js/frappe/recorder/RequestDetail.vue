        ...
        <div class="sort-selector">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li
                v-for="(column, index) in table_columns.filter(
                  (c) => c.sortable
                )"
                :key="index"
                ...
                <div class="form-grid">
                  ...
                  <div class="grid-body">
                    <div class="rows">
                      <div
                        class="grid-row"
                        :class="showing == call.index ? 'grid-row-open' : ''"
                          ...
                          >
                            <div class="toolbar grid-header-toolbar">
                              <span class="panel-title"
                                >SQL Query #<span class="grid-form-row-index">{{
                                  call.index
                                }}</span></span
                              >
                              <div
                              ...
                              >
                                <span
                                  class="hidden-xs octicon octicon-triangle-up"
                                ></span>
                              </div>
                            </div>
                          </div>
...
export default {
  ...
  methods: {
    paginated: function (calls) {
      calls = calls.slice();
      this.query.pagination.total = Math.ceil(
        calls.length / this.query.pagination.limit
      );
      const begin =
        (this.query.pagination.page - 1) * this.query.pagination.limit;
