<template>
  <div class="file-preview">
      ...
      <div>
        ...
        <span class="flex" v-else>
          ...
          <button
            ...
            @click="$emit('toggle_private')"
            :title="__('Toggle Public/Private')"
          >
    ...
    <div class="file-actions">
      ...
      <div
        v-if="file.failed"
        v-html="frappe.utils.icon('solid-red', 'lg')"
      ></div>
      <button
        v-if="!uploaded && !file.uploading"
        class="btn"
        @click="$emit('remove')"
...
export default {
  ...
  computed: {
    ...
    uploaded() {
      return (
        this.file.total &&
        this.file.total === this.file.progress &&
        !this.file.failed
      );
    },
    is_image() {
