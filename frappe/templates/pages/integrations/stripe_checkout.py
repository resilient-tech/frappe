...
import json
from frappe.integrations.doctype.stripe_settings.stripe_settings import (
...
def get_context(context):
    ...
    if not (set(expected_keys) - set(list(frappe.form_dict))):
        ...
        if frappe.db.get_value(
            context.reference_doctype, context.reference_docname, "is_a_subscription"
        ):
        ...
        frappe.redirect_to_message(
            ...
            _(
                "Looks like someone sent you to an incomplete URL. Please ask them to"
                " look into it."
            ),
        )
