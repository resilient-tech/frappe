...
"""
    ...
    def validate_standard(self):
        if self.is_standard and not frappe.conf.developer_mode:
            frappe.throw(
                _(
                    "Cannot edit Standard Notification. To edit, please disable this"
                    " and duplicate it"
                )
            )
    ...
    def send(self, doc):
        ...
        if self.set_property_after_alert:
            ...
            try:
                ...
                frappe.log_error(
                    title="Document update failed", message=frappe.get_traceback()
                )
        ...
        for recipient in self.recipients:
            ...
            if recipient.receiver_by_role:
                receiver_list += get_info_based_on_role(
                    recipient.receiver_by_role, "mobile_no"
                )
